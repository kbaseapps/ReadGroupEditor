...
function ReadGroupEditor(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.save_read_group = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ReadGroupEditor.save_read_group",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "ReadGroupEditor.status",

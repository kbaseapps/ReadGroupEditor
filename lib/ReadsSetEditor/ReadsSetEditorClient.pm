package ReadsSetEditor::ReadsSetEditorClient;
...
ReadsSetEditor::ReadsSetEditorClient
...
sub new
{
    ...
    my $self = {
	client => ReadsSetEditor::ReadsSetEditorClient::RpcClient->new,
	url => $url,
	headers => [],
    };
...
sub _validate_version {
    ...
    if ($sMinor > $cMinor) {
        warn "New client version available for ReadsSetEditor::ReadsSetEditorClient\n";
    }
    if ($sMajor == 0) {
        warn "ReadsSetEditor::ReadsSetEditorClient version is $svr_version. API subject to change.\n";
    }
}
...
package ReadsSetEditor::ReadsSetEditorClient::RpcClient;

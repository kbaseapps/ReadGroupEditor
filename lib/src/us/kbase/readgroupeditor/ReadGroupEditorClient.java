package us.kbase.readgroupeditor;
...
public class ReadGroupEditorClient {
     ...
     */
    public ReadGroupEditorClient(URL url) {
     ...
     * validity.
     */
    public ReadGroupEditorClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ReadGroupEditorClient(URL url, String user, String password) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public ReadGroupEditorClient(URL url, String user, String password, URL auth) throws UnauthorizedException, IOException {
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("ReadGroupEditor.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
